...
NostrEvent _nostrEventDeserialize(
  ...
  final object = NostrEvent(
    ...
    sig: reader.readString(offsets[5]),
...
extension NostrEventQueryWhereSort
  ...
  QueryBuilder<NostrEvent, NostrEvent, QAfterWhere> anyIsarId() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(const IdWhereClause.any());
    });
  }

  QueryBuilder<NostrEvent, NostrEvent, QAfterWhere> anyCreatedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension NostrEventQueryWhere
  ...
  QueryBuilder<NostrEvent, NostrEvent, QAfterWhereClause> isarIdEqualTo(
      Id isarId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NostrEvent, NostrEvent, QAfterWhereClause> isarIdNotEqualTo(
      Id isarId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NostrEvent, NostrEvent, QAfterWhereClause> isarIdGreaterThan(
      Id isarId,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<NostrEvent, NostrEvent, QAfterWhereClause> isarIdLessThan(
      Id isarId,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<NostrEvent, NostrEvent, QAfterWhereClause> isarIdBetween(
    Id lowerIsarId,
    Id upperIsarId, {
  ...
  QueryBuilder<NostrEvent, NostrEvent, QAfterWhereClause> createdAtEqualTo(
      int createdAt) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<NostrEvent, NostrEvent, QAfterWhereClause> createdAtNotEqualTo(
      int createdAt) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<NostrEvent, NostrEvent, QAfterWhereClause> createdAtGreaterThan(
    int createdAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NostrEvent, NostrEvent, QAfterWhereClause> createdAtLessThan(
    int createdAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NostrEvent, NostrEvent, QAfterWhereClause> createdAtBetween(
    int lowerCreatedAt,
    int upperCreatedAt, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension NostrEventQueryFilter
  ...
  QueryBuilder<NostrEvent, NostrEvent, QAfterFilterCondition> isarIdEqualTo(
      Id value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isarId',
  ...
  QueryBuilder<NostrEvent, NostrEvent, QAfterFilterCondition> isarIdGreaterThan(
    Id value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NostrEvent, NostrEvent, QAfterFilterCondition> isarIdLessThan(
    Id value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NostrEvent, NostrEvent, QAfterFilterCondition> isarIdBetween(
    Id lower,
    Id upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension NostrEventQuerySortThenBy
  ...
  QueryBuilder<NostrEvent, NostrEvent, QAfterSortBy> thenByIsarId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isarId', Sort.asc);
    });
  }

  QueryBuilder<NostrEvent, NostrEvent, QAfterSortBy> thenByIsarIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension NostrEventQueryProperty
  ...
  QueryBuilder<NostrEvent, int, QQueryOperations> isarIdProperty() {
    return QueryBuilder.apply(this, (query) {
